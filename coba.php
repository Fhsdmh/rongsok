...
<!--End of Tawk.to Script-->
  <body style="margin-top: 30px;">
            ...
            <div class="modal-body">
              <form action="register.php" method="POST">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" name="nama_lengkap" placeholder="Masukkan Nama lengkap Anda" required oninvalid="this.setCustomValidity('Mohon masukkan Nama lengkap Anda!')" oninput="setCustomValidity('')">
                </div>

                <div class="form-group">
                  <label for="no telepon">No. Telepon</label>
                  <input type="number" class="form-control" name="no_telepon" placeholder="Masukkan No. telepon Anda" required oninvalid="this.setCustomValidity('Mohon masukkan No. telepon Anda!')" oninput="setCustomValidity('')">
                </div>

                <div class="form-group">
                  <label for="email">Email</label>
                  <input type="email" class="form-control" name="email" placeholder="Masukkan Email Anda" required oninvalid="this.setCustomValidity('Mohon masukkan Email Anda!')" oninput="setCustomValidity('')">
                  <small id="emailHelp" class="form-text text-muted">Kami tidak akan memberi tahu siapapun tentang Email Anda</small>
                </div>

                <div class="form-group">
                  <label for="password">Password</label>
                  <input type="password" class="form-control" name="password" placeholder="Masukkan Password Anda" required oninvalid="this.setCustomValidity('Mohon masukkan Password Anda!')" oninput="setCustomValidity('')">
                ...
                <div class="form-group">
                  ...
                  <input type="password" class="form-control" name="konfirmasi_password" placeholder="Konfirmasi ulang Password Anda" required oninvalid="this.setCustomValidity('Mohon masukkan ulang Password Anda!')" oninput="setCustomValidity('')">
                </div>
    ...
    <div class="row">
      ...
      <button type="button" class="btn" data-toggle="modal" data-target="#exampleModalCenter4" style="font-weight: bold;">Mulai Jual</button>
    </div>
  ...
  if(window.location.href.indexOf('#exampleModalCenter3') != -1) {
...
"<script>
  swal('Good job!', 'Email berhasil dikirim!', 'success')
  </script>";
...
{ 
  ...
  { 
    document.getElementById('nama_lengkap2').value=document. 
             getElementById('nama_lengkap').value; 
    document.getElementById('no_telepon2').value=document. 
             getElementById('no_telepon').value 
  }
} 
</script> 
...
swal("No. telepon Anda telah terdaftar sebelumnya!", "Silahkan masukkan password Anda", "success", {
        content: {
    element: "input",
    attributes: {
